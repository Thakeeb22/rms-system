...
if (!resetToken) {
  showMessage("Invalid or missing reset token. Please request a new link from the login page.", "error");
...
resetPasswordForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    showMessage(response.data?.message || "Password reset successfully! Redirecting to login...", "success");
