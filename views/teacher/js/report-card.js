...
async function loadInitialData() {
  try {
    ...
    if (dashboardRes.ok && dashboardRes.data?.dashboard) {
      ...
      populateSessionTermDropdowns(dashboard.currentSession, dashboard.currentTerm);
    }
  } catch (error) {
...
function populateStudentDropdown() {
  ...
  studentSelect.innerHTML = '<option value="">Select a student</option>' +
    teacherStudents.map(s => `<option value="${s._id}">${s.fullname} (${s.admissionNumber})</option>`).join("");
}

function populateSessionTermDropdowns(currentSession, currentTerm) {
...
function renderReportPreview(report) {
  ...
  preview.innerHTML = `
    <div class="max-w-4xl mx-auto">
      ...
      <!-- Summary -->
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6 p-4 bg-blue-50 rounded-lg">
        <div>
        ...
        <div class="mb-6">
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
              ${report.assessment.affective ? Object.entries(report.assessment.affective).map(([key, value]) => `
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
              ${report.assessment.psychomotor ? Object.entries(report.assessment.psychomotor).map(([key, value]) => `
                <div class="flex justify-between items-center p-2 bg-gray-50 rounded">
...
function downloadPDF() {
  ...
  // Open PDF in new tab - uses the token from localStorage
